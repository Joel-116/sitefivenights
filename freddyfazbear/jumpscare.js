document.addEventListener('DOMContentLoaded', function () {
    ...
    // Configuração do áudio de jumpscare com múltiplos formatos
    const audioSources = [
        { src: 'sound/_sound.mp3', type: 'audio/mp3' },
        { src: 'sound/_sound.ogg', type: 'audio/ogg' },
        { src: 'sound/_sound.wav', type: 'audio/wav' }
    ];
    ...
    audioSources.forEach(source => {
        ...
        jumpscareAudio.appendChild(sourceElement);
    });
